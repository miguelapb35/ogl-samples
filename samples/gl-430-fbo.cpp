...
namespace
{
	...
	std::string const VERT_SHADER_SOURCE_TEXTURE(glf::DATA_DIRECTORY + "gl-430/fbo-texture-2d.vert");
	std::string const FRAG_SHADER_SOURCE_TEXTURE(glf::DATA_DIRECTORY + "gl-430/fbo-texture-2d.frag");
	std::string const VERT_SHADER_SOURCE_SPLASH(glf::DATA_DIRECTORY + "gl-430/fbo-splash.vert");
	std::string const FRAG_SHADER_SOURCE_SPLASH(glf::DATA_DIRECTORY + "gl-430/fbo-splash.frag");
