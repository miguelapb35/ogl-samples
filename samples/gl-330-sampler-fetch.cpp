...
namespace
{
	...
	std::string const VERTEX_SHADER_SOURCE(glf::DATA_DIRECTORY + "gl-330/fetch.vert");
	std::string const FRAGMENT_SHADER_SOURCE(glf::DATA_DIRECTORY + "gl-330/fetch.frag");
