...
namespace
{
	std::string const SAMPLE_NAME("OpenGL Texture Integer");
	std::string const VERT_SHADER_SOURCE(glf::DATA_DIRECTORY + "gl-330/texture-integer.vert");
	std::string const FRAG_SHADER_SOURCE(glf::DATA_DIRECTORY + "gl-330/texture-integer.frag");
