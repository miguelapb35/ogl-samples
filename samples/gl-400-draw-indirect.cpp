...
namespace
{
	...
	std::string const VERTEX_SHADER_SOURCE(glf::DATA_DIRECTORY + "gl-400/flat-color.vert");
	std::string const FRAGMENT_SHADER_SOURCE(glf::DATA_DIRECTORY + "gl-400/flat-color.frag");
