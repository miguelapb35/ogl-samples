...
namespace
{
	std::string const SAMPLE_NAME("OpenGL Framebuffer Depth Render");
	...
	std::string const VERT_SHADER_SOURCE_SPLASH(glf::DATA_DIRECTORY + "gl-320/fbo-depth.vert");
	std::string const FRAG_SHADER_SOURCE_SPLASH(glf::DATA_DIRECTORY + "gl-320/fbo-depth.frag");
