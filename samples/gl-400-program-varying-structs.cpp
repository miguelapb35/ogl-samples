...
namespace
{
	std::string const SAMPLE_NAME = "OpenGL Varying structs";	
	std::string const SAMPLE_VERTEX_SHADER(glf::DATA_DIRECTORY + "gl-400/tess-struct.vert");
	std::string const SAMPLE_CONTROL_SHADER(glf::DATA_DIRECTORY + "gl-400/tess-struct.cont");
	std::string const SAMPLE_EVALUATION_SHADER(glf::DATA_DIRECTORY + "gl-400/tess-struct.eval");
	std::string const SAMPLE_GEOMETRY_SHADER(glf::DATA_DIRECTORY + "gl-400/tess-struct.geom");
	std::string const SAMPLE_FRAGMENT_SHADER(glf::DATA_DIRECTORY + "gl-400/tess-struct.frag");
