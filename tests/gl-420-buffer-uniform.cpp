...
namespace
{
	glf::window Window("gl-420-buffer-uniform");
...
void display()
{
...

	{
		...
		{
			glm::mat4 ViewRotateX = glm::rotate(ViewTranslate, Window.RotationCurrent.y + glm::pi<float>() * 0.25f, glm::vec3(1.f, 0.f, 0.f));
			glm::mat4 View = glm::rotate(ViewRotateX, Window.RotationCurrent.x + glm::pi<float>() * 0.50f + glm::pi<float>() * 0.25f, glm::vec3(0.f, 1.f, 0.f));
			glm::mat4 Model = glm::mat4(1.0f);
			glm::mat4 MVP = Projection * View * Model;
