...
namespace
{
	char const * SAMPLE_NAME = "OpenGL Image Rectangle";
	char const * VERTEX_SHADER_SOURCE("gl-330/texture-rect.vert");
	char const * FRAGMENT_SHADER_SOURCE("gl-330/texture-rect.frag");
