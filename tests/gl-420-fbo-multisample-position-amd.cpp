...
namespace
{
	...
	glf::window Window("gl-420-fbo-multisample-position-amd", glm::ivec2(SAMPLE_SIZE_WIDTH, SAMPLE_SIZE_HEIGHT));
...
void renderFBO()
{
...

	{
		...
		glm::mat4 View = glm::rotate(ViewTranslate,-glm::pi<float>() * 0.1f, glm::vec3(0.f, 0.f, 1.f));
