...
class gl_400_fbo_multisample_mack : public test
{
public:
	gl_400_fbo_multisample_mack(int argc, char* argv[])
		: test(argc, argv, "gl-400-fbo-multisample-mask", test::CORE, 4, 0, glm::vec2(glm::pi<float>() * 0.2f))
		, VertexArrayName(0)
		, BufferName(0)
		, ProgramName(0)
		, UniformMVP(0)
...
int main(int argc, char* argv[])
{
	...
	gl_400_fbo_multisample_mack Test(argc, argv);
	Error += Test();
