//**********************************
// OpenGL OpenGL Matching by location
...
namespace
{
	std::string const SAMPLE_NAME("OpenGL Matching by location");
	std::string const SAMPLE_VERT_SHADER(glf::DATA_DIRECTORY + "gl-XXX/matching-by-location.vert");
	std::string const SAMPLE_CONT_SHADER(glf::DATA_DIRECTORY + "gl-XXX/matching-by-location.cont");
	std::string const SAMPLE_EVAL_SHADER(glf::DATA_DIRECTORY + "gl-XXX/matching-by-location.eval");
	std::string const SAMPLE_GEOM_SHADER(glf::DATA_DIRECTORY + "gl-XXX/matching-by-location.geom");
	std::string const SAMPLE_FRAG_SHADER(glf::DATA_DIRECTORY + "gl-XXX/matching-by-location.frag");
