...
namespace
{
	...
	std::string const SAMPLE_GEOM_SHADER(glf::DATA_DIRECTORY + "gl-XXX/matching-by-variable.geom");
	std::string const SAMPLE_FRAG_SHADER(glf::DATA_DIRECTORY + "gl-XXX/matching-by-variable.frag");
